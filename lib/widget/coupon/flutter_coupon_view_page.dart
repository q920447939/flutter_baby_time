...
class FlutterCouponViewPage extends StatefulWidget {
  const FlutterCouponViewPage({Key? key}) : super(key: key);
...
class _FlutterStaggeredGridViewPage extends State<FlutterCouponViewPage> {
  @override
