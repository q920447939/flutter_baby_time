                ...
                SizedBox(
                  ...
                  child: ChartWidget(
                    foregroundWidget: const Positioned(
                        right: 0,
                        bottom: 40,
                        child: Icon(Icons.ad_units, color: Colors.blue)),
                    coordinateRender: ChartDimensionsCoordinateRender(
                      ...
                      //提示的文案信息
                      tooltipBuilder:
                          (BuildContext context, List<ChartLayoutState> body) {
                        String text =
                            '我可以滚动我可以滚动\n我可以滚动我可以滚动\n我可以滚动我可以滚动\n我可以滚动我可以滚动';
                  ...
                  child: ChartWidget(
                    ...
                    coordinateRender: ChartDimensionsCoordinateRender(
                      foregroundAnnotations: [
                        ...
                        LabelAnnotation(
                            positions: [6, 380], text: '380', fixed: true),
                      ],
                      ...
                      tooltipBuilder:
                        ...
                        return PreferredSize(
                          ...
                          child: Container(
                            padding: const EdgeInsets.all(8),
                            child: Text(
                                body.map((e) => e.selectedIndex).toString()),
                          ),
                        );
                      },
                      yAxis: [
                    ...
                    coordinateRender: ChartDimensionsCoordinateRender(
                      ...
                      charts: [
                        Line(
                          ...
                          shaders: [
                            ui.Gradient.linear(
                                Offset.zero, const Offset(0, 200), [
                        ...
                        charts: [
                          Line(
                            ...
                            shaders: [
                              ...
                              ui.Gradient.linear(
                                Alignment.topCenter.withinRect(Rect.fromLTWH(
                                    0, 0, cs.maxWidth, cs.maxHeight)),
                                Alignment.bottomCenter.withinRect(Rect.fromLTWH(
                                    0, 0, cs.maxWidth, cs.maxHeight)),
                                <Color>[
                                  Colors.blue,
                                  Colors.yellow,
